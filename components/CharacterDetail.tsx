      ...
      <div className="flex-1 flex flex-col lg:flex-row relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 z-[120] flex items-center justify-between p-6 lg:p-12 pointer-events-none">
          ...
          <div className="pointer-events-auto flex items-center gap-4 cursor-pointer group" onClick={onBack}>
            ...
            />
            <span className="text-xl lg:text-3xl font-light text-white/60 ml-2">{isBook ? "Store" : "Character"}</span>
          </div>
          ...
          <div className="flex items-center gap-3 lg:gap-4 pointer-events-auto">
            ...
            >
              ...
              <span>{isBook ? "Back to Gallery" : "Close"}</span>
            </button>
          </div>
        </div>
        ...
        <div className="relative flex-1 flex flex-col lg:flex-row h-full">
          ...
          {/* LEFT: Hero Character Image or Book Cover */}
            ...
            <div className={`px-6 md:px-16 lg:px-12 py-10 lg:py-16 transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
              ...
              <div className="mb-10 lg:mb-14">
                ...
                {isBook && (
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <span className="px-3 py-1 bg-white/20 backdrop-blur-md rounded-lg text-white text-xs font-bold uppercase tracking-widest border border-white/20">Hardcover</span>
                  </div>
                )}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12 p-8 lg:p-12 bg-white/5 backdrop-blur-3xl rounded-[32px] lg:rounded-[40px] border border-white/10 mb-12">
                  {isBook ? (
                    <>
                      <div>
                        <div className="text-[10px] lg:text-[11px] uppercase opacity-50 mb-3 font-black text-white tracking-[0.2em]">Pages</div>
                        <div className="text-lg lg:text-2xl font-black text-white">{character.pages} Pages</div>
                      </div>
                      <div>
                        <div className="text-[10px] lg:text-[11px] uppercase opacity-50 mb-3 font-black text-white tracking-[0.2em]">Age Range</div>
                        <div className="text-lg lg:text-2xl font-black text-white">{character.ageRange}</div>
                      </div>
                      <div className="col-span-2 md:col-span-1">
                        <div className="text-[10px] lg:text-[11px] uppercase opacity-50 mb-3 font-black text-white tracking-[0.2em]">Publisher</div>
                        <div className="text-lg lg:text-2xl font-black text-white truncate">{character.publisher}</div>
                      </div>
                    </>
                  ) : (
                    <>
              ...
              {isBook ? (
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-center text-white/40 text-sm font-bold uppercase tracking-widest">Free Worldwide Shipping on Orders Over $50</p>
                </div>
              ) : (
                /* Special Clips Section for Characters */
